              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700 dark:text-amber-400 mt-1">
                    We recommend taking a baseline test first to establish your
                    cognitive baseline. This will allow you to track changes in
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              ...
              <CardContent className="pt-2">
                <div className="aspect-video bg-muted/30 rounded-md flex items-center justify-center mb-4 overflow-hidden">
                  <div className="scale-75">
                    <NBackGrid size="sm" highlightedPosition={4} />
                  </div>
                </div>

                <p className="text-sm text-muted-foreground">
                  The N-Back test measures your working memory and attention.
                  You'll need to remember positions in a sequence and identify
                  matches.
                </p>
              </CardContent>
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="pt-2">
                ...
                <p className="text-sm text-muted-foreground">
                  The Reaction Time test measures how quickly you can respond to
                  visual stimuli. It tests your processing speed and reflexes.
                </p>
              </CardContent>
