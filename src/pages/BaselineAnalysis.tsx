...
export default function BaselineAnalysis() {
  ...
  const [showInsufficientDataMessage, setShowInsufficientDataMessage] =
    useState(false);
    ...
    <div className="container max-w-4xl py-6 space-y-6">
      ...
      {isLoadingTests ? (
          ...
          <CardContent className="space-y-6">
            <div className="bg-secondary/10 p-6 rounded-lg text-center">
              ...
              <p className="text-muted-foreground mb-4">
                Complete at least 2 cognitive tests to establish your baseline.
                More tests will provide a more accurate baseline.
              </p>
        ...
        <div className="space-y-6">
          <BaselineCalibration
            onBaselineCalculated={handleBaselineCalculated}
          />
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Understanding the importance of establishing an accurate
                cognitive baseline
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  A cognitive baseline is a reference point that represents your
                  typical cognitive performance before starting any supplements.
                  It serves as the foundation for measuring changes in your
              ...
              <div className="space-y-2">
                ...
                <ul className="list-disc list-inside text-muted-foreground">
                  <li>
                    Measure the true impact of supplements on your cognitive
                    performance
                  </li>
                  <li>
                    Distinguish between normal variations and supplement-induced
                    changes
                  </li>
                  <li>
                    Make data-driven decisions about which supplements are
                    effective for you
                  </li>
                  <li>
                    Track your cognitive performance over time with a reliable
                    reference point
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-2">
                ...
                <ul className="list-disc list-inside text-muted-foreground">
                  <li>
                    Take at least 3-5 cognitive tests before starting any
                    supplements
                  </li>
                  <li>
                    Maintain consistent testing conditions (time of day,
                    environment, etc.)
                  </li>
                  <li>
                    Avoid testing when unusually tired, stressed, or under the
                    influence of substances
                  </li>
                  <li>
                    Recalibrate your baseline periodically or when life
