  ...
  return (
    <div className="container py-6 sm:py-8 md:py-10 max-w-6xl px-4 sm:px-6 md:px-8 relative pb-20 sm:pb-6 md:pb-10">
      ...
      <div className="flex items-center text-sm text-muted-foreground mb-6 sm:mb-8 overflow-x-auto whitespace-nowrap pb-2">
        ...
        <ChevronRight
          size={14}
          className="mx-1 text-muted-foreground/50 flex-shrink-0"
        />
      ...
      <div className="flex flex-col lg:flex-row gap-6 md:gap-8">
            ...
            <CardContent className="pt-20 pb-6 px-6">
              <div className="text-center mb-8">
                ...
                {userStats.daysActive > 0 && (
                  <Badge
                    variant="outline"
                    className="mt-3 bg-primary/15 hover:bg-primary/20 py-1.5 px-3 transition-colors duration-200"
                  >
                    <Trophy className="h-3.5 w-3.5 mr-1.5 text-primary" />
                    <span className="font-medium">
                      Active for {userStats.daysActive} days
                    </span>
                  </Badge>
                )}
              </div>
                ...
                <div className="bg-muted/30 p-6 rounded-lg border border-border/30">
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:gap-5 text-sm">
                    <div className="bg-background/80 p-3 sm:p-4 rounded-md border border-border/20 transition-all duration-200 hover:border-border/50 hover:shadow-sm hover:-translate-y-0.5">
                      <p className="text-muted-foreground mb-1 sm:mb-2 text-[13px] sm:text-[14px] font-medium tracking-wide">
                        Tests Taken
                      </p>
                    ...
                    <div className="col-span-2 bg-background/80 p-3 sm:p-4 rounded-md border border-border/20 transition-all duration-200 hover:border-border/50 hover:shadow-sm">
                      <div className="flex justify-between mb-1.5 sm:mb-2">
                        <p className="text-muted-foreground text-[13px] sm:text-[14px] font-medium tracking-wide">
                          Profile Completion
                        </p>
                      ...
                      <div className="relative">
                        <Progress
                          ...
                          style={{
                            ...
                            "--tw-gradient-from":
                              userStats.completionRate < 30
                                ? "#e2e8f0"
                                : userStats.completionRate < 70
                                  ? "#c4b5fd"
                                  : "#8b5cf6",
                          }}
        ...
        <div className="w-full lg:w-3/5 xl:w-2/3">
          ...
          >
            ...
            <TabsContent
              value="personal"
              className="mt-0 transition-all duration-300 animate-in fade-in-50 slide-in-from-left-5 data-[state=inactive]:animate-out data-[state=inactive]:fade-out-0 data-[state=inactive]:slide-out-to-left-5"
            >
            ...
            <TabsContent
              value="preferences"
              className="mt-0 transition-all duration-300 animate-in fade-in-50 slide-in-from-right-5 data-[state=inactive]:animate-out data-[state=inactive]:fade-out-0 data-[state=inactive]:slide-out-to-right-5"
            >
              <Card className="border-border/40 shadow-sm hover:shadow-md transition-all duration-300">
                <CardHeader className="pb-4 pt-6 px-8">
                  <CardTitle className="text-xl flex items-center gap-2">
                  ...
                  <CardDescription className="text-sm mt-1.5">
                    Customize your application settings and experience
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6 pt-6 px-8">
                  <div className="flex items-center justify-between p-5 rounded-lg bg-muted/30 border border-border/30 transition-all duration-200 hover:border-border/50 hover:shadow-sm">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground leading-relaxed max-w-md">
                        Receive email updates about your account activity, test
                  ...
                  <div className="flex items-center justify-between p-5 rounded-lg bg-muted/30 border border-border/30 transition-all duration-200 hover:border-border/50 hover:shadow-sm">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground leading-relaxed max-w-md">
                        Switch to a darker color theme that's easier on your
