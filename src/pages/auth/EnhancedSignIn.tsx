    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-primary/10 to-primary/30 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-0 w-full h-full" style={{
            backgroundImage: 'radial-gradient(circle at 25px 25px, rgba(var(--foreground), 0.1) 2%, transparent 0%)',
          ...
          <div className="mt-auto">
            <div className="bg-background/20 backdrop-blur-md rounded-xl p-6 border border-white/10 shadow-lg animate-slide-up">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2 text-foreground">Track Your Cognitive Performance</h2>
      ...
      >
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 left-0 w-full h-full" style={{
            backgroundImage: 'radial-gradient(circle at 25px 25px, rgba(var(--primary), 0.15) 2%, transparent 0%), radial-gradient(circle at 75px 75px, rgba(var(--primary), 0.15) 2%, transparent 0%)',
        ...
        <div className="w-full max-w-md relative z-10">
          <Card className="border border-border/30 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-sm bg-card/95 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
            <CardHeader className="space-y-3 pb-6">
              ...
              <CardTitle className="text-2xl font-bold text-center">Welcome to Holistiq</CardTitle>
              <CardDescription className="text-center px-2">
                Track your cognitive performance and discover what works for you
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-5 px-6">
              ...
              <div className="flex flex-col gap-1.5">
                <h3 className="text-sm font-medium">Sign in or create your account</h3>
                <p className="text-sm text-muted-foreground">
                  New users will be automatically registered when signing in with Google for the first time.
                </p>
              </div>
              ...
              <div className="bg-muted/30 p-4 rounded-lg border border-border/50">
                <div className="flex gap-3 items-start">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Holistiq helps you track the effectiveness of supplements on your cognitive performance through standardized tests and data analysis.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardFooter className="flex flex-col space-y-5 pt-2 px-6 pb-6">
              ...
              <Button
                ...
                onClick={async () => {
                  try {
                    setIsLoading(true);
                    console.log("Starting Google sign-in with remember me:", rememberMe);
              ...
              <div className="text-xs text-center text-muted-foreground pt-2">
                ...
                <Link to="/terms" className="text-primary underline-offset-4 hover:underline transition-colors">
                  Terms of Service
                </Link>{' '}and{' '}
                <Link to="/privacy" className="text-primary underline-offset-4 hover:underline transition-colors">
                  Privacy Policy
                </Link>
              </div>
            </CardFooter>
