  ...
  return (
    <div className="container py-12 max-w-3xl">
      ...
      <div className="space-y-4 text-muted-foreground">
        ...
        <p>
          NooTrack ("we", "us", "our") is committed to protecting your privacy.
          This Privacy Policy explains how we collect, use, disclose, and
          safeguard your information when you use our website and app
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>
            Process and track your cognitive assessments and supplement intake
          </li>
          <li>Generate insights and visualizations of your data</li>
        ...
        <p>
          ...
          to fulfill the purposes outlined in this Privacy Policy. You can
