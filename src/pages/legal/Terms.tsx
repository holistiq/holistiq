  ...
  return (
    <div className="container py-12 max-w-3xl">
      ...
      <div className="space-y-4 text-muted-foreground">
        <p>
          <strong>Last Updated:</strong> April 23, 2023
        </p>

        <p>
          Please read these Terms of Service ("Terms") carefully before using
          NooTrack ("the Service"). By accessing or using the Service, you agree
        ...
        <p>
          ...
          supplement intake decisions. Our cognitive assessments are for
          informational purposes only and should not be interpreted as medical
          advice.
        </p>
        ...
        <p>
          ...
          owned by NooTrack and are protected by international copyright,
          trademark, and other intellectual property laws. You may not
          reproduce, distribute, modify, create derivative works of, publicly
          display, or use any content from our Service without prior written
          consent.
        </p>
        ...
        <p>
          In no event shall NooTrack be liable for any indirect, incidental,
        ...
        <p>
          ...
          NooTrack disclaims all warranties of any kind, whether express or
