...
export const LoadingState = React.memo(function LoadingState({
  ...
  const LoadingIcon = icon === 'brain'
    ? <Brain className={cn(iconSizeClass, "text-primary animate-pulse")} aria-hidden="true" />
    : <Loader2 className={cn(iconSizeClass, "text-primary animate-spin")} aria-hidden="true" />;
