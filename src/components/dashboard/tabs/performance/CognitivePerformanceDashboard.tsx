...
import { DashboardLoadingState, DashboardEmptyState } from '@/components/dashboard/common/DashboardStates';
...
export const CognitivePerformanceDashboard = memo(function CognitivePerformanceDashboard({
  ...
  const [metricsLoadingStatus, setMetricsLoadingStatus] = useState<LoadingStatus>(LoadingStatus.IDLE);
  const [supplementsLoadingStatus, setSupplementsLoadingStatus] = useState<LoadingStatus>(LoadingStatus.IDLE);
  const [factorsLoadingStatus, setFactorsLoadingStatus] = useState<LoadingStatus>(LoadingStatus.IDLE);
  ...
  const handleSupplementsLoadingChange = useCallback((status: LoadingStatus) => {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-xl font-semibold">Cognitive Performance Dashboard</h2>
      </div>
