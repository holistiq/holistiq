...
export const ComprehensiveChartRenderer = memo(
  function ComprehensiveChartRenderer({
    processedData,
    chartId,
    chartTitle,
    chartDescription,
              ...
              >
                ...
                <Tooltip
                  content={(props: ChartTooltipProps) =>
                    ComprehensiveChartTooltipContent(props, maTrendData)
                  }
                />
                ...
                {showInteractiveLegend && (
                  <Legend
                    content={
                      <InteractiveLegend
                        chartConfig={
                          chartConfig as unknown as Record<
                            string,
                        ...
                        baselineValues={
                          baselineValues as unknown as Record<
                            string,
                            number | null
                          >
                        }
                        ...
                        trendData={
                          trendData as unknown as Record<
                            string,
                            {
                  ...
                  <>
                    ...
                    {effectiveShowMA && (
                      <Line
                        ...
                        onMouseEnter={() =>
                          setHighlightedMetric("reactionTimeMA")
                        }
                        onMouseLeave={() => setHighlightedMetric(null)}
                      />
                    )}
