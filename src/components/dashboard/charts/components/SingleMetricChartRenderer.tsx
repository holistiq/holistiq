    ...
    <div className={className}>
      ...
      <div
        ...
        style={{
          ...
          marginBottom: '40px' /* Increased bottom margin to create more space for the legend */
        }}
        ...
        <div style={{ width: '100%', height: '100%', minHeight: '300px', position: 'relative' }}>
          <ResponsiveContainer width="100%" height="100%">
            ...
            <XAxis
              ...
              minTickGap={5}
              height={50}
              ticks={processedData.finalChartData.length <= 10
            ...
            {(() => {
              if (!(baselineValues && showBaselineReference && baselineValues[dataKey])) {
                return null;
              }
              ...
              const labelPosition = dataKey === 'reactionTime' ? 'insideBottomLeft' : 'insideTopLeft';
