        ...
        <div className="space-y-5">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Moving Average (MA) lines smooth out short-term fluctuations to
              show the underlying trend in your cognitive performance.
            </p>
          </div>
            ...
            <div className="flex items-start space-x-3 bg-slate-50 dark:bg-slate-900 p-2 rounded-md">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Your average performance over the last 3 test sessions,
          ...
          <div className="space-y-3 pt-3 border-t">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              <div className="flex items-start space-x-3 bg-slate-50 dark:bg-slate-900 p-2 rounded-md">
                ...
                <div>
                  <p className="text-xs font-medium">
                    Falling MA Line (Score & Accuracy)
                  </p>
                  <p className="text-xs text-muted-foreground">
              ...
              <div className="flex items-start space-x-3 bg-slate-50 dark:bg-slate-900 p-2 rounded-md">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    A falling MA line is good (faster reactions), while a rising
                    line indicates slower reactions.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-2 pt-3 border-t">
            ...
            <ul className="text-xs space-y-2 list-disc pl-5">
              ...
              <li>
                Compare your latest result to the MA line to see if you're
                improving
              </li>
              <li>
                Look for sustained changes in MA direction when evaluating
          ...
          <div className="pt-3 border-t text-xs text-muted-foreground bg-slate-50 dark:bg-slate-900 p-2 rounded-md">
            ...
            <p>
              MA lines use a 3-point moving average calculation, which averages
              each point with the two previous points.
            </p>
          </div>
        </div>
      </PopoverContent>
