...
export function Breadcrumbs({ className = "", maxDepth = 4 }: Readonly<BreadcrumbsProps>) {
  ...
  const breadcrumbHierarchy: Record<string, string[]> = {
    ...
    'supplement-effectiveness': ['dashboard', 'supplements', 'supplement-effectiveness'],

    // Confounding factors section
    'confounding-factors': ['dashboard', 'confounding-factors'],
    'log-confounding-factor': ['dashboard', 'confounding-factors', 'log-confounding-factor'],
    ...
    'log-washout-period': ['dashboard', 'supplements', 'washout-periods', 'log-washout-period'],
    'washout-period-guide': ['dashboard', 'supplements', 'washout-periods', 'washout-period-guide'],

    // Analysis
    'analysis': ['dashboard', 'analysis'],
    'statistical-significance': ['dashboard', 'analysis', 'statistical-significance'],
    'comparative-visualization': ['dashboard', 'analysis', 'comparative-visualization'],
  ...
  return (
    <div className={`flex items-center text-sm text-muted-foreground overflow-x-auto ${className}`}>
      <Link to="/" className="flex items-center hover:text-foreground min-w-fit">
