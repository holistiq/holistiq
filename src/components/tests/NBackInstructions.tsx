...
export function NBackInstructions({
  nBackLevel,
  onReady,
  onCancel,
}: NBackInstructionsProps) {
  return (
    <Card className="w-full">
      ...
      <CardContent className="space-y-6">
        <div className="space-y-4">
          ...
          <p>
            You'll see squares appearing on a 3×3 grid one at a time. Your task
            is to identify when the
            <strong>
              {" "}
              current position matches the position from {nBackLevel} steps
              earlier
            </strong>
            .
          </p>
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>
              Press the <strong>spacebar</strong> or the{" "}
              <strong>Match button</strong> when you see a position that matches
              the one from {nBackLevel} steps earlier
            </li>
            <li>Try to respond as quickly and accurately as possible</li>
            <li>
              Don't worry if you miss some - this test is designed to be
              challenging
            </li>
          </ul>
        </div>
