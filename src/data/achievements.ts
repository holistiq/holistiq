...
export const achievements: Achievement[] = [
  ...
  },
  {
    ...
    description:
      "Complete your baseline cognitive assessment - essential for measuring changes",
    category: AchievementCategory.TESTING,
    difficulty: AchievementDifficulty.EASY,
    icon: "activity",
    requiredCount: 1,
  ...
  },
  {
    ...
    description:
      "Complete tests on three consecutive days - building a reliable data pattern",
    category: AchievementCategory.TESTING,
    difficulty: AchievementDifficulty.EASY,
    icon: "calendar",
    requiredCount: 3,
  ...
  },
  {
    ...
    description:
      "Complete tests on seven consecutive days - essential for accurate supplement assessment",
    category: AchievementCategory.TESTING,
    difficulty: AchievementDifficulty.MEDIUM,
    icon: "calendar-check",
    requiredCount: 7,
  ...
  },
  {
    ...
    description:
      "Complete tests on thirty consecutive days - providing comprehensive data for analysis",
    category: AchievementCategory.TESTING,
  ...
  // SUPPLEMENTS CATEGORY - All supplement tracking and evaluation achievements
  {
    ...
    description:
      "Log your first supplement - the first step in tracking effectiveness",
  ...
  },
  {
    ...
    description:
      "Log supplements for 14 consecutive days - essential for establishing patterns",
    category: AchievementCategory.SUPPLEMENTS,
    difficulty: AchievementDifficulty.HARD,
    icon: "calendar-clock",
    requiredCount: 14,
  ...
  },
  {
    ...
    description:
      "Log 10 supplements with detailed notes about effects and experience",
    category: AchievementCategory.SUPPLEMENTS,
    difficulty: AchievementDifficulty.MEDIUM,
    icon: "clipboard-list",
    requiredCount: 10,
  ...
  },
  {
    ...
    description:
      "Complete a full supplement cycle (start, consistent use, evaluation)",
    category: AchievementCategory.SUPPLEMENTS,
    difficulty: AchievementDifficulty.MEDIUM,
    icon: "refresh-cw",
    requiredCount: 1,
  ...
  },
  {
    ...
    description:
      "Complete 3 supplement evaluations with before/after cognitive tests",
    category: AchievementCategory.SUPPLEMENTS,
    difficulty: AchievementDifficulty.HARD,
    icon: "bar-chart-2",
    requiredCount: 3,
  ...
  },
  {
    ...
    description:
      "Log supplements with complete information (brand, dosage, timing) 15 times",
    category: AchievementCategory.SUPPLEMENTS,
    difficulty: AchievementDifficulty.HARD,
    icon: "check-circle",
    requiredCount: 15,
  ...
  // ENGAGEMENT CATEGORY - Profile, account, and general app usage achievements
  {
    ...
    description:
      "Complete your user profile - helps personalize your experience",
  ...
  },
  {
    ...
    description:
      "Log confounding factors (sleep, stress, etc.) alongside 5 tests",
    category: AchievementCategory.ENGAGEMENT,
    difficulty: AchievementDifficulty.MEDIUM,
    icon: "layers",
    requiredCount: 5,
  ...
  },
  {
    ...
    title: "Early Adopter",
    description:
      "Join during the beta phase of HolistiQ - thank you for helping us improve!",
    category: AchievementCategory.ENGAGEMENT,
    difficulty: AchievementDifficulty.EASY,
    icon: "rocket",
    requiredCount: 1,
