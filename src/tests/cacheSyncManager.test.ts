...
import { CacheSyncManager, SyncMessageType, DEFAULT_SYNC_CONFIG } from '../lib/cacheSyncManager';
...
describe('CacheSyncManager', () => {
  ...
  test('should receive messages from other tabs', () => {
    ...
    localStorageMock.setItem('holistiq_cache_sync', JSON.stringify(syncMessage));
